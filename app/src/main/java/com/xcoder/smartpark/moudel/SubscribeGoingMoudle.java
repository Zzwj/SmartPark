...
public class SubscribeGoingMoudle implements Serializable{
    ...
    private String STATUS;//0待审核 1未出行 2已出行 3 审核未通过  //  0待审核（处长审批） 1未出行(审批通过）  2已出行 3 审核未通过 4 上车 5 用车管理员审批
    private String COLOR;//颜色
    private String CAR_TYPE;//车辆类型 0公车 1专车

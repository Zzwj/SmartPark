...
import com.xcoder.smartpark.util.Utils;
...
//			LogUtils.d("objects["+i+"]="+objects[i]);
//		}
//		//参1,上下文
//		//参2,布局文件的资源id
...
//		LogUtils.d("mLvIBeacons.setAdapter----");
//	}
//
...
//			ToastUtil.showToast("device==null");
//			return;
//		}
...
//		LogUtils.d("mBleDeviceMaps.size="+mBleDeviceMaps.size());
//    }
//
//	//--------------------------------定时维护集合----------------------------
//

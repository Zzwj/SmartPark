...
import com.xcoder.smartpark.view.bus.BusListView;
...
public class BusListService {
    ...
    private BusListActivity busListActivity;
    ...
    public void init(BusListActivity busListActivity) {
        ...
        childFragmentManager = busListActivity.getSupportFragmentManager();
    }
    ...
    public void selectFragment(String tag) {
        bv.bus_main_wrok_bt.setTextColor(busListActivity.getResources().getColor(R.color.app_green_color));
        bv.bus_main_wrok_bt.setBackgroundResource(R.drawable.bus_main_bt_border_shape);
        bv.bus_main_home_bt.setTextColor(busListActivity.getResources().getColor(R.color.app_green_color));
        bv.bus_main_home_bt.setBackgroundResource(R.drawable.bus_main_bt_border_shape);
        bv.bus_main_temporary_bt.setTextColor(busListActivity.getResources().getColor(R.color.app_green_color));
        ...
        if (TextUtils.equals(tag, wrokTag)) {//点击上班
            bv.bus_main_wrok_bt.setTextColor(busListActivity.getResources().getColor(R.color.white));
            ...
            bv.bus_main_home_bt.setTextColor(busListActivity.getResources().getColor(R.color.white));
            ...
            bv.bus_main_temporary_bt.setTextColor(busListActivity.getResources().getColor(R.color.white));

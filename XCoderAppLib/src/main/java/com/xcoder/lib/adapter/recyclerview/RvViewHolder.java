...
public class RvViewHolder extends RecyclerView.ViewHolder {
    ...
    private RvItemListener.onItemClickListener rvClick;
    private RvItemListener.onLongItemClickListener rvLongClick;
    ...
    public RvItemListener.onItemClickListener addRvItemListener(RvItemListener.onItemClickListener itemClickListener) {
        this.rvClick = itemClickListener;
        //实现item的点击事件
        mConvertView.setOnClickListener(new View.OnClickListener() {
            @Override
            public void onClick(View v) {
                if (rvClick != null) {
                    rvClick.onItemClickListener(v, getAdapterPosition());
                }
            }
        });
    ...
    public RvItemListener.onLongItemClickListener addRvItemLongListener(RvItemListener.onLongItemClickListener longItemClickListener) {
        //实现item的长按事件
        mConvertView.setOnLongClickListener(new View.OnLongClickListener() {
            @Override
            public boolean onLongClick(View v) {
                if (rvLongClick != null) {
                    rvLongClick.onLongItemClickListener(v, getAdapterPosition());
                }
                return true;
            }
        });

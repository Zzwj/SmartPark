...
public class AppPathManager {
     ...
     * @param path
     * @return
     * @方法说明：webview中修改帖子缓存目录
     * @方法名称：getWebDownImgPath
     * @返回值：String
     */
    public static String getWebDownImgPath(String path) {
        return getExternalRootCachePath().append("image/").append(path)
                .toString();
    }

    /**
     * @方法说明：得到主目录文件的路径
     * @方法名称：getScanImagePath
     * @返回值：void
     */
    public static StringBuffer getScanImagePath() {
        String path = "";
    ...
    public static String getSaveLogPath() {
        if (Utils.isEmpty(getScanImagePath().toString())) {
            return "";
        }
        return getScanImagePath().append("app_errLog/").toString();
    }
    ...
    public static String getSaveApkPath() {
        ...
        return getScanImagePath().append("appApk/").toString();
    }
    ...
    /**
     * @return
     * @方法说明：将二维码图片路径保存在另外文件夹下面
     * @方法名称：getSaveImagePath
     * @返回值：String
     */
    public static String getShareImagePath() {
        ...
        return getScanImagePath().append("Share_image/").toString();
    }
